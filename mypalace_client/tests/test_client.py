...
async def test_reflect_session_async_returns_job_pending():
    ...
    from mypalace_client import JobPending
...
async def test_promote_memory():
    ...
    client = make_client(handler)
    from mypalace_client import MemoryDynamics
...
async def test_score_memory():
    ...
    client = make_client(handler)
    from mypalace_client import ScoreBreakdown
...
async def test_set_intention():
    ...
    client = make_client(handler)
    from mypalace_client import Intention
...
async def test_check_intentions():
    ...
    client = make_client(handler)
    from mypalace_client import FiredIntention
...
async def test_assemble_layered_context():
    from mypalace_client import LayeredContext
    captured: dict = {}
...
async def test_get_supersessions():
    from mypalace_client import Supersession
    captured: dict = {}
