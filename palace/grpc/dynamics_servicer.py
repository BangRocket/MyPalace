...
def _dynamics_to_proto(d) -> palace_pb2.MemoryDynamics:
    return palace_pb2.MemoryDynamics(
...
class DynamicsServicer(palace_pb2_grpc.DynamicsServiceServicer):
    async def PromoteMemory(
        self, request: palace_pb2.PromoteMemoryRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.DynamicsResponse:
        ...
        return palace_pb2.DynamicsResponse(dynamics=_dynamics_to_proto(dyn))

    async def DemoteMemory(
        self, request: palace_pb2.DemoteMemoryRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.DynamicsResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
    ...
    async def GetDynamics(
        self, request: palace_pb2.GetDynamicsRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.DynamicsResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
    ...
    async def ScoreMemory(
        self, request: palace_pb2.ScoreMemoryRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.ScoreBreakdownResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
        ...
        return palace_pb2.ScoreBreakdownResponse(
            breakdown=palace_pb2.ScoreBreakdown(
