...
class RetrievalServicer(palace_pb2_grpc.RetrievalServiceServicer):
    async def AssembleLayered(
        self,
        request: palace_pb2.AssembleLayeredRequest,
        context: grpc.aio.ServicerContext,
    ) -> palace_pb2.LayeredContextResponse:
        auth = current_auth()
        ...
        ctx_msg = palace_pb2.LayeredContext(
            l1_user_profile=palace_pb2.LayeredL1(
            ...
            l2_relevant_context=palace_pb2.LayeredL2(
            ...
            char_counts=palace_pb2.LayeredCharCounts(
        ...
        if l3 is not None:
            ctx_msg.l3_graph_context.CopyFrom(palace_pb2.LayeredL3Graph(
                related_memories_json=_dumps(l3.get("related_memories")),
                edges_json=_dumps(l3.get("edges")),
            ))
        return palace_pb2.LayeredContextResponse(context=ctx_msg)
