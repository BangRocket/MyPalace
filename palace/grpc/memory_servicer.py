...
def _memory_to_proto(m: Memory) -> palace_pb2.Memory:
    return palace_pb2.Memory(
        id=m.id,
        user_id=m.user_id,
...
class MemoryServicer(palace_pb2_grpc.MemoryServiceServicer):
    async def CreateMemory(
        self, request: palace_pb2.CreateMemoryRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.MemoryResponse:
        auth = current_auth()
        ...
        return palace_pb2.MemoryResponse(memory=_memory_to_proto(memory))

    async def GetMemory(
        self, request: palace_pb2.GetMemoryRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.MemoryResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
    ...
    async def DeleteMemory(
        self, request: palace_pb2.DeleteMemoryRequest, context: grpc.aio.ServicerContext,
    ...
    async def SearchMemories(
        self, request: palace_pb2.SearchMemoriesRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.SearchMemoriesResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
        ...
        return palace_pb2.SearchMemoriesResponse(
            results=[
                palace_pb2.ScoredMemory(memory=_memory_to_proto(m), score=float(score))
                for m, score in results
            ],
        )

    async def ListMemories(
        self, request: palace_pb2.ListMemoriesRequest, context: grpc.aio.ServicerContext,
    ) -> palace_pb2.ListMemoriesResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
        ...
        return palace_pb2.ListMemoriesResponse(
