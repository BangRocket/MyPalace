...
from mypalace._llm_utils import strip_json_fences
...
from mypalace.models import DEFAULT_TENANT_ID, Memory, MemorySupersession, utcnow
from mypalace.prompts.ingestion import SMART_INGEST_PROMPT
...
class SmartIngestionService:
    ...
    async def _record_supersession(
        ...
        try:
            ...
            from mypalace.database import async_session as _async_session
            from mypalace.memory_service import _next_version_number, _record_version
            ...
            import logging
            logging.getLogger("mypalace.memory.versions").warning(
