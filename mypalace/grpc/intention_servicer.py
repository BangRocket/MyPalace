...
def _intention_to_proto(i) -> mypalace_pb2.Intention:
    return mypalace_pb2.Intention(
        id=i.id,
        user_id=i.user_id,
        agent_id=i.agent_id,
        content=i.content,
...
def _fired_to_proto(f: dict) -> mypalace_pb2.FiredIntention:
    return mypalace_pb2.FiredIntention(
        id=f.get("id", "") or "",
...
class IntentionServicer(mypalace_pb2_grpc.IntentionServiceServicer):
    async def SetIntention(
        self, request: mypalace_pb2.SetIntentionRequest, context: grpc.aio.ServicerContext,
    ) -> mypalace_pb2.IntentionResponse:
        auth = current_auth()
        ...
        return mypalace_pb2.IntentionResponse(intention=_intention_to_proto(intention))

    async def CheckIntentions(
        self, request: mypalace_pb2.CheckIntentionsRequest, context: grpc.aio.ServicerContext,
    ) -> mypalace_pb2.FiredIntentionsResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
        ...
        return mypalace_pb2.FiredIntentionsResponse(
            fired=[_fired_to_proto(f) for f in fired],
        )

    async def FormatIntentions(
        self, request: mypalace_pb2.FormatIntentionsRequest, context: grpc.aio.ServicerContext,
    ) -> mypalace_pb2.FormattedIntentionsResponse:
        ...
        return mypalace_pb2.FormattedIntentionsResponse(text=text)

    async def ListIntentions(
        self, request: mypalace_pb2.ListIntentionsRequest, context: grpc.aio.ServicerContext,
    ) -> mypalace_pb2.IntentionsResponse:
        auth = current_auth()
        tenant_id = auth.resolve_tenant()
        ...
        return mypalace_pb2.IntentionsResponse(
            intentions=[_intention_to_proto(i) for i in intentions],
        )

    async def DeleteIntention(
        self, request: mypalace_pb2.DeleteIntentionRequest, context: grpc.aio.ServicerContext,
